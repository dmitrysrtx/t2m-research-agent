...
3. Consolidated Comparative Table (Must preserve columns: Paper Title & Year formatted as [Title (Year)](URL), Citations, Impact Factor, Code Repository (GitHub) strictly formatted as [owner/repo](https://github.com/owner/repo) or N/A, Method/Architecture, Key Metrics, Limitations)
